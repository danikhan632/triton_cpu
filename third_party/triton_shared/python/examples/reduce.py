...
n_rows = 16
n_cols = 32
x = torch.rand([n_cols, n_rows], device="cpu", dtype=torch.bfloat16)
...
ret = triton.compile(reduce_kernel_2d, signature="*bf16,*bf16,i32,i32", constants={"BLOCK_SIZE": 32}, device_type="cpu")
# print(ret.asm["ttir"])
