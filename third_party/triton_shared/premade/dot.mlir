#map = affine_map<(d0, d1) -> (d0, d1)>Mi76#b>9mRed
module {
  func.func @kernel(%arg0: memref<*xbf16>, %arg1: memref<*xbf16>, %arg2: memref<*xbf16>, %arg3: i32, %arg4: i32, %arg5: i32, %arg6: i32, %arg7: i32, %arg8: i32) {
    ...
    %mask = arm_sve.create_full_mask() : () -> svbool
    // Use ARM SVE masked add operation
    %8 = arm_sve.masked.addf %mask, %in, %in_4 : bf16
      linalg.yield %8 : bf16
    } -> tensor<128x256xbf16>
    memref.tensor_store %7, %reinterpret_cast_2 : memref<128x256xbf16, strided<[?, 1]>>
    return
  }
}

assume that the whole vector is 256 bits
there is also a 8bit predicate vector

we are dealthing with f32 so the 0th bit applyies to first 32 bits
etc

setting this bit to 1 makes this 32bit lane active
