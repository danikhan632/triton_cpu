...
struct LinalgToX86Pass : public LinalgToX86Base<LinalgToX86Pass> {
...
public:
  ...
  void runOnOperation() override {
...

    {
      ...
      populateLinalgToX86CanonicalizationPatterns(patterns);
    ...
    triton::populateLinalgToX86ConversionPatterns(
...
std::unique_ptr<OperationPass<ModuleOp>> triton::createLinalgToX86Pass() {
  return std::make_unique<LinalgToX86Pass>();
}
